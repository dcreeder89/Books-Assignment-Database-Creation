CREATE DATABASE  IF NOT EXISTS `fav_books` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `fav_books`;
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
-- Host: 192.168.1.6    Database: fav_books
-- ------------------------------------------------------
...
-- Dump completed on 2023-02-23  8:18:08
